...
public class Zadatak_10a {

	  // Rekurzivna definicija metoda 
	public static
	int fibonaciRekurzivno(int n){
		// izlaz iz rekurzije
		if(n == 0 || n == 1)
			return 1; 
		// rekurzivni korak
	...
	public static void main(String[] args){
		...
		int n; System.out.print("Unesite ceo nenegativan broj " + " - negativan za kraj: ");
		while((n = ulaz.nextInt()) >= 0){
			// Rekurzivna varijanta 
			long vremePocetak = System.nanoTime();
			int fibonaciR = Zadatak_10a.fibonaciRekurzivno(n);
			...
			int fibonaciI = Zadatak_10a.fibonaciIterativno(n);
		...
		} // Ima negde problem sa prekopiranjem videcu kad budem radio sam
