...
public class Box {
	 ...
	 * 
	 * Private: 
	 * - Najrestriktivniji nivo pristupa.
	 * Privatnom članu mogu da pristupe samo ostali članovi klase
	 * u kojoj je on definisan. - Članovi izvedene klase ne mogu da mu pristupe.
	 * Privatni članovi deklarišu se ključnom reči private.
	 * 
	 * Protected: 
	 * - Zaštićenim članovima mogu da pristupaju članovi klase u kojoj je definisana,
	 ...
	 * 
	 * Package: 
	 * - Ovo je nivo pristupa koji se dobija ukoliko se ne navede nijedan
	 * deklarator nivoa pristupa. 
	 * - Ovaj nivo pristupa dozvoljava klasama unutar istog paketa da pristupi
	 * članovima klase. Podrazumeva se da su klase unutar istog paketa 
	 * poverljivi prijatelji.
	 */
}
